...
#SBATCH --cpus-per-task=1#4           # cpus per node out of 32
...
srun python /leonardo/home/userexternal/nalghamd/programs/mace-0.3.12/mace/cli/run_train.py \
    --name="MACE_1" \
    --train_file="../../bulk-700-REF_train.xyz" \
    --valid_file="../../bulk-700-REF_valid.xyz" \
    --loss='universal' \
    ...
    --num_samples=200\
    --pt_train_file='../../train_mp_finetuning-MACE_100.xyz' \
